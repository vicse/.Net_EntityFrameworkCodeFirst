...
namespace University.Controllers
{
    public class OfficeAssignmentsController : Controller
    {
        ...
        {
            ViewBag.InstructorID = new SelectList(db.Instructors.Where(i => i.Estado == true), "ID", "LastName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "InstructorID,Location")] OfficeAssignment officeAssignment)
        {
            ...
            ViewBag.InstructorID = new SelectList(db.Instructors.Where(i => i.Estado == true), "ID", "LastName", officeAssignment.InstructorID);
            return View(officeAssignment);
        }
